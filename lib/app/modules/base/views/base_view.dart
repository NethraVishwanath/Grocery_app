...
import 'package:badges/badges.dart' as custom_badge; // Importing badges package with an alias
...
class BaseView extends GetView<BaseController> {
  ...
  BottomNavigationBarItem _mBottomNavItem({required String label, required String icon}) {
