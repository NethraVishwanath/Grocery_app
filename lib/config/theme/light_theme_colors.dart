...
class LightThemeColors
{
  ...
  static const Color onprimaryColor = Color(0xFF23AA49);
  ...
  static const Color onaccentColor = Color(0xFFFF324B);
  static const Color canvasColor = Color(0xFFF3F5F7);
  static const Color surface = Color(0xFFD9EDE1);
  static const Color onsurface = Color(0xFFFF324B);
  static const Color onbackground = Color(0xFF172C38);
  static const Color error = Color(0xFFD9EDE1);
  static const Color onerror = Color(0xFF172C38);
